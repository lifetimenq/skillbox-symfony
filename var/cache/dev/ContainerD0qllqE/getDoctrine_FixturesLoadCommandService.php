...
class getDoctrine_FixturesLoadCommandService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).'/vendor/doctrine/data-fixtures/src/OrderedFixtureInterface.php';
        include_once \dirname(__DIR__, 4).'/src/DataFixtures/ArticleContentFixtures.php';
        ...
        $a->addFixtures([0 => ['fixture' => new \App\DataFixtures\ArticleContentFixtures(), 'groups' => []], 1 => ['fixture' => new \App\DataFixtures\ModuleFixtures(($container->privates['App\\Repository\\UserRepository'] ?? $container->load('getUserRepositoryService'))), 'groups' => []], 2 => ['fixture' => new \App\DataFixtures\UserFixtures(($container->privates['security.user_password_hasher'] ?? $container->load('getSecurity_UserPasswordHasherService'))), 'groups' => []]]);
