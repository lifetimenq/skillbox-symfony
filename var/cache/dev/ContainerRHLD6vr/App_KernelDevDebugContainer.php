...
class App_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            'App\\Controller\\ApiArticleGeneratorController' => 'getApiArticleGeneratorControllerService',
            'App\\Controller\\ArticleGeneratorController' => 'getArticleGeneratorControllerService',
            ...
            'App\\Service\\ProfileUpdateService' => 'getProfileUpdateServiceService',
            'App\\Service\\RegistrationService' => 'getRegistrationServiceService',
        ...
        $this->privates['service_container'] = function () {
            ...
            include_once \dirname(__DIR__, 4).'/src/Twig/Extension/MorphExtension.php';
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('MQBzfgNVpP', 0, ($this->targetDir.''.'/pools/app'), new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL, true));
    ...
    {
        return $this->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('bCSN5fdExU', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['logger'] ?? $this->getLoggerService())));
    }
    ...
    {
        return $this->services['cache.validator_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('ybOu3yXyO1', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['logger'] ?? $this->getLoggerService())));
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        $b = new \Doctrine\Bundle\DoctrineBundle\Middleware\DebugMiddleware(($this->privates['doctrine.debug_data_holder'] ??= new \Doctrine\Bundle\DoctrineBundle\Middleware\BacktraceDebugDataHolder([])), ($this->privates['debug.stopwatch'] ??= new \Symfony\Component\Stopwatch\Stopwatch(true)));
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $a->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            'App\\Repository\\ApiTokenRepository' => ['privates', 'App\\Repository\\ApiTokenRepository', 'getApiTokenRepositoryService', true],
            'App\\Repository\\ArticleContentRepository' => ['privates', 'App\\Repository\\ArticleContentRepository', 'getArticleContentRepositoryService', true],
            'App\\Repository\\GeneratedArticlesRepository' => ['privates', 'App\\Repository\\GeneratedArticlesRepository', 'getGeneratedArticlesRepositoryService', true],
            'App\\Repository\\ModuleRepository' => ['privates', 'App\\Repository\\ModuleRepository', 'getModuleRepositoryService', true],
            'App\\Repository\\UnregisteredUsersRepository' => ['privates', 'App\\Repository\\UnregisteredUsersRepository', 'getUnregisteredUsersRepositoryService', true],
            'App\\Repository\\UserRepository' => ['privates', 'App\\Repository\\UserRepository', 'getUserRepositoryService', true],
        ], [
            'App\\Repository\\ApiTokenRepository' => '?',
            'App\\Repository\\ArticleContentRepository' => '?',
            'App\\Repository\\GeneratedArticlesRepository' => '?',
            'App\\Repository\\ModuleRepository' => '?',
            'App\\Repository\\UnregisteredUsersRepository' => '?',
    ...
    {
        return $this->privates['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('Ee6azD-IH4', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['logger'] ?? $this->getLoggerService())));
    }
    ...
    {
        return $this->privates['cache.property_info'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('lydLJrwvYB', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['logger'] ?? $this->getLoggerService())));
    }
    ...
    {
        return $this->privates['cache.security_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('Ta25Nfw4MG', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['logger'] ?? $this->getLoggerService())));
    }
    ...
    {
        return $this->privates['cache.security_token_verifier'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('jhvPtJS50R', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['logger'] ?? $this->getLoggerService())));
    }
    ...
    {
        return $this->privates['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('V0FrMxDIHt', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['logger'] ?? $this->getLoggerService())));
    }
    ...
    {
        return $this->privates['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('DILs7e3C9j', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['logger'] ?? $this->getLoggerService())));
    }
    ...
    protected function getLocaleAwareListenerService()
    {
        return $this->privates['locale_aware_listener'] = new \Symfony\Component\HttpKernel\EventListener\LocaleAwareListener(new RewindableGenerator(function () {
            yield 0 => ($this->privates['slugger'] ??= new \Symfony\Component\String\Slugger\AsciiSlugger('ru'));
    ...
    {
        return $this->privates['locale_listener'] = new \Symfony\Component\HttpKernel\EventListener\LocaleListener(($this->services['request_stack'] ??= new \Symfony\Component\HttpFoundation\RequestStack()), 'ru', ($this->services['router'] ?? $this->getRouterService()), false, []);
    }
    ...
    protected function getTwigService()
    {
        ...
        $instance->addExtension(new \App\Twig\Extension\MorphExtension());
        ...
        $instance->addRuntimeLoader(new \Twig\RuntimeLoader\ContainerRuntimeLoader(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            'App\\Twig\\Runtime\\MorphExtensionRuntime' => ['privates', 'App\\Twig\\Runtime\\MorphExtensionRuntime', 'getMorphExtensionRuntimeService', true],
            ...
            'App\\Twig\\Runtime\\MorphExtensionRuntime' => '?',
    ...
    private $loadedDynamicParameters = [
        ...
        'app.email_no_reply' => false,
        'app.email_from' => false,
        'kernel.secret' => false,
    ...
    private function getDynamicParameter(string $name)
    {
        $value = match ($name) {
            ...
            'app.email_no_reply' => $this->getEnv('EMAIL_NO_REPLY'),
            'app.email_from' => $this->getEnv('EMAIL_FROM'),
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'images_upload_directory' => (\dirname(__DIR__, 4).'/public/uploads/article_images'),
