...
class getMailer_TransportFactory_NullService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['mailer.transport_factory.null'] = new \Symfony\Component\Mailer\Transport\NullTransportFactory($a, NULL, ($container->privates['logger'] ?? $container->getLoggerService()));
    }
}
